   ...
   return (
     <>
       <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
         <div>
           <h1
             className={`text-orange-500 text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl`}
           >
             About Us
           </h1>
           <p className="text-xl text-stone-600">
             Welcome to AuctoBid, the ultimate destination for online auctions
         ...
         <div>
           ...
           <p className="text-xl text-stone-600">
             At AuctoBid, our mission is to revolutionize the way people buy and
         ...
         <div>
           ...
           <p className="text-xl text-stone-600">
             Founded by Mohit Chaudhari, AuctoBid was born out of a passion for
         ...
         <div>
           ...
           <p className="text-xl text-stone-600">
             Whether you're looking to buy, sell, or simply explore, AuctoBid
         ...
         <div>
           <p className="text-[#d6482b] text-xl font-bold mb-3">
             Thank you for choosing AuctoBid. We look forward to being a part of
