      ...
      <section className="w-full m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-center">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-md shadow-xl">
          ...
          >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <select
                    ...
                    className="text-[16px] py-2 bg-transparent border-b-2 border-black focus:outline-none  sm:flex-1"
            ...
            <button
              className="bg-transparent font-bold hover:text-white hover:bg-orange-500 transition-all duration-300 text-xl mx-auto w-[280px] lg:w-[640px] m-10 py-2 rounded-xl border-2 shadow-xl"
              type="submit"
              disabled={loading}
            >
              {loading && "Registering..."}
